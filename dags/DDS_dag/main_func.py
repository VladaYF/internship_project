...
def transfer():
    ...
    storage['category'] = [cleared_df_category, df_error_category, category_primary_key]
    ...
    storage['product'] = [cleared_df_product, df_error_product, product_primary_key]
    ...
    # stars filter
    print('НАЧАЛО ФИЛЬТРАЦИИ')
    cleared_df_stock, df_error_stock = df_filter_stock(stock_data, product_primary_key)
